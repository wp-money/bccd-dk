<?php
	...
	function themezee_get_social_settings() {
		...
		$themezee_settings[] = array("name" => __('Show Social Media Icons in Header?', 'themezee_lang'),
						"desc" => __('Check this to display the SocialMedia Icons in the header area. You can also display the Social Icons with the <b>Social Media Widget.</b>', 'themezee_lang'),
